...
\begin{abstract}
The objective of this research is to verify the compatibility between the different Browser Extensions, Mobile and Desktop Wallets to interact using the gasLimit, gasPrice, PriorityFee and Nonce parameters, something needed for the optimization of the gas and prurpose of a transaction.
\end{abstract}
